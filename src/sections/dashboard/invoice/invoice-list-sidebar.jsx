...
const useGetCustomerNames = () => {
  const dispatch = useDispatch();
  const names = useSelector((state) => state.customers.names);

  const handleCustomerNamesGet = useCallback(() => {
    dispatch(thunks.getCustomerNames());
  }, [dispatch]);

  useEffect(
      () => {
        handleCustomerNamesGet();
      },
...
export const InvoiceListSidebar = (props) => {
  ...
  const customers = useGetCustomerNames();
