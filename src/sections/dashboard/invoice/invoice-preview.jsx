...
export const InvoicePreview = (props) => {
  ...
  const subtotalAmount = numeral(invoice.amount).format(`${invoice.currency}0,0.00`);
  const taxAmount = numeral(invoice.taxAmount).format(`${invoice.currency}0,0.00`);
  const totalAmount = numeral(invoice.amount).format(`${invoice.currency}0,0.00`);
      ...
      <Table sx={{ mt: 4 }}>
        ...
        <TableBody>
          {items.map((item, index) => {
            ...
            const totalAmount = numeral(item.amount).format(`${item.currency}0,0.00`);
          ...
          <TableRow>
            ...
            >
              <Typography variant="subtitle2">
                {subtotalAmount}  {invoice.currency}
              </Typography>
            </TableCell>
          </TableRow>
          <TableRow>
